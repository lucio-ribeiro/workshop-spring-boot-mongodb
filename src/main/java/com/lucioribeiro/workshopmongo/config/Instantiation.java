package com.lucioribeiro.workshopmongo.config;
...
import com.lucioribeiro.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post3 = new Post(null, sdf.parse("10/05/2024"), "Bom bom", "Acordei!", new AuthorDTO(bob));
